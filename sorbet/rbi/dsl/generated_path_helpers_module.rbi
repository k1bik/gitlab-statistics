...
module GeneratedPathHelpersModule
  ...
  def config_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def config_project_member_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def config_project_members_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def config_project_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def config_projects_path(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def projects_list_config_projects_path(*args); end
