...
module GeneratedUrlHelpersModule
  ...
  def config_project_member_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def config_project_members_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def config_project_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def config_projects_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def config_url(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def projects_list_config_projects_url(*args); end
